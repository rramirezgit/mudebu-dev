...
const TABLE_HEAD = [
  { id: 'orderId', label: 'Orden', width: 100 },
  { id: 'author', label: 'Cliente', width: 100 },
  { id: 'createdAt', label: 'Fecha de creación', width: 200 },
...
export default function ListView() {
  ...
  const [tableData, setTableData] = useState<ItemTable[]>([]);
            ...
            <Tab
              ...
              icon={
                ...
                >
                  ...
                  {tab.value === 'NEW' && tableData.filter((user) => user.status === 'NEW').length}
